...
import com.example.calling.databinding.ActivityConnectingBinding;
...
public class ConnectingActivity extends AppCompatActivity {
    ...
    FirebaseAuth auth;
   // private Button backBtn=backBtn;
                                                ...
                                                .child(username).addValueEventListener(new ValueEventListener() {
                                                    ...
                                                    public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                                                        if(snapshot.child("status").exists()) {
                                                            /*if(snapshot.child("incoming")==snapshot.child("createdBy")){

                                                                AlertDialog dialog= new AlertDialog.Builder(ConnectingActivity.this)
                                                                        .setTitle("Oops....")
                                                                        .setMessage("People Online = 0 \n Try Again")
...
@Override
    ...
    //database.getReference().child("").child("createdBy").setValue(null);
        database.getReference().child("users").removeValue();
        finish();
        /* database.getReference().child("users").removeEventListener(new ValueEventListener() {
            @Override
