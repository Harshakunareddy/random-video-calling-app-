...
import com.example.calling.databinding.ActivityCallBinding;
import com.harsha.calling.models.InterfaceJava;
...
if(incoming.equalsIgnoreCase(friendsUsername))
        ...
        binding.mikeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                isAudio = !isAudio;
                callJavaScriptFunction("javascript:toggleAudio(\""+isAudio+"\")");
                if(isAudio){
                    binding.mikeBtn.setImageResource(R.drawable.btn_unmute_normal);
                } else {
                    binding.mikeBtn.setImageResource(R.drawable.btn_unmute_pressed);
                }
            }
        });
    ...
    void sendCallRequest(){
        if(!isPeerConnected) {
            Toast.makeText(this, "You are not connected. Please check your internet.", Toast.LENGTH_SHORT).show(); return;
        }
        listenConnId();
    }
    void listenConnId()
